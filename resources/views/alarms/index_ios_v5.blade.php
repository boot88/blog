...
ctx.beginPath();
ctx.moveTo(80,80);
ctx.lineTo(80+35*Math.cos(hAngle),80+35*Math.sin(hAngle));
ctx.lineWidth=4;
ctx.strokeStyle='#444';
ctx.stroke();
...
ctx.beginPath();
ctx.moveTo(80,80);
ctx.lineTo(80+50*Math.cos(mAngle),80+50*Math.sin(mAngle));
ctx.lineWidth=3;
ctx.strokeStyle='#666';
ctx.stroke();
...
el.closest('.alarm').classList.toggle('disabled');
}
